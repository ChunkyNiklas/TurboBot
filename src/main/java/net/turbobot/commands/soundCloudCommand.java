...
/*
 Class: soundCloudCommand
 Date: 05.04.2021
 Coded by Niklas / Chunky Niklas#0001
*/
public class soundCloudCommand {
	public soundCloudCommand(GuildMessageReceivedEvent event, Member member, Guild guild, TextChannel txt, String[] args) {

		if (args.length == 1) {
			txt.sendMessage(EmbedCreator.getError(member).setTitle("Error Occurred").setDescription("Format: `+SoundCloud NAME/LINK`").setFooter("Simply player-error. (This " +
